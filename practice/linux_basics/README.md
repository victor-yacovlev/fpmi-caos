...
Для редактора Emacs необходимо установить из MELPA пакет `clang-format`, и дописать в конфигурационный файл `~/.emacs` строчки:
```
(require 'clang-format)
(setq clang-format-style "file")
(global-auto-revert-mode t)  ;; автозагрузка изменений
```
