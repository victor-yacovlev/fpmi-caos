...
5. [Архитектура x86-64 и язык ассемблера](practice/x86-64)
6. [Векторные вычисления и набор команд AVX](practice/avx)
...
### Модуль 2 (осень 2021)
    ...
    7. [Динамическая загрузка библиотек](practice/dynlib/) 
